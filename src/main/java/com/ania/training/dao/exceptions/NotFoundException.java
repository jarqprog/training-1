...
public class NotFoundException extends Exception {
    ...
    public <T extends Identification> NotFoundException(Class<T> clazz, long id, Exception root) {
        super(String.format("Object of %s with id=%s not found!", clazz.getSimpleName(), id), root);
    }
}
